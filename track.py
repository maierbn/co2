...
parser = argparse.ArgumentParser(description='Track CO2 value')
...
while True:
  ...
  # dump value to log file
  with open("co2.csv", "a") as file:
    file.write(f"{datetime.datetime.now().timestamp()};{value} \n")
  ...
  generate_plot = not args.noshow or i % int(60*60/sampling_time) == 0
